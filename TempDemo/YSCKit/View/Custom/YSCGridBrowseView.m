...
- (void)setCollectionViewCell:(NSString *)collectionViewCell {
    ...
    if (IS_NIB_EXISTS(collectionViewCell)) {
        [self.collectionView registerNib:[UINib nibWithNibName:collectionViewCell bundle:nil]
              forCellWithReuseIdentifier:kParamItemCellIdentifier];
    }
    else {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    YSCBaseCollectionViewCell *cell = [self.collectionView dequeueReusableCellWithReuseIdentifier:kParamItemCellIdentifier forIndexPath:indexPath];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    if (OBJECT_ISNOT_EMPTY(self.collectionViewCell) &&
