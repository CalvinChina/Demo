...
@property (nonatomic, readonly) unsigned long long diskSpace;

/// Free disk space in byte. (-1 when error occurs)
@property (nonatomic, readonly) unsigned long long diskSpaceFree;

/// Used disk space in byte. (-1 when error occurs)
@property (nonatomic, readonly) unsigned long long diskSpaceUsed;
