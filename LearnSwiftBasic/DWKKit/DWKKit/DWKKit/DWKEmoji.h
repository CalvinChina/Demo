...
//DWKKit支持的emoji表情0(source)
#define DWKEMOJI_SUPPORT_VALUE @[ \
@"❤️",@"😄",@"😆",@"😊",@"😃",@"😏",@"😍",@"😘",@"😚",@"😳",  \
@"😌",@"😆",@"😁",@"😉",@"😜",@"😝",@"😀",@"😗",@"😙",@"😛", \
@"😴",@"😟",@"😦",@"😧",@"😮",@"😬",@"😕",@"😯",@"😑",@"😒", \
@"😅",@"😓",@"😥",@"😩",@"😔",@"😞",@"😖",@"😨",@"😰",@"😣", \
...
//YSCKit支持的emoji表情1
#define DWKEMOJI_SUPPORT_REGEX @"❤️😄😆😊😃😏😍😘😚😳😌😆😁😉😜😝😀😗😙😛😴😟😦😧😮😬😕😯😑😒😅😓😥😩😔😞😖😨😰😣😢😭😂😲😱😫😠😡😤😪😋😷😎😵😐😶😇👍👎👏👉👈"

//DWKKit支持的emoji表情2
#define DWKEMOJI_SUPPORT_UNICODE2ALIAS @{ \
@"😄"	:	@":smile:", \
@"😆"	:	@":satisfied:", \
@"😊"	:	@":blush:", \
@"😃"	:	@":smiley:", \
...
//DWKKit支持的emoji表情3
#define DWKEMOJI_SUPPORT_ALIAS2UNICODE @{ \
@":smile:"	:	@"😄", \
@":satisfied:"	:	@"😆", \
@":blush:"	:	@"😊", \
@":smiley:"	:	@"😃", \
...
//所有的emoji表情别名和unicode对照表
#define DWKEMOJI_HASH @{ \
@":+1:"                                : @"\U0001F44D", \
@":-1:"                                : @"\U0001F44E", \
@":100:"                               : @"\U0001F4AF", \
@":1234:"                              : @"\U0001F522", \
