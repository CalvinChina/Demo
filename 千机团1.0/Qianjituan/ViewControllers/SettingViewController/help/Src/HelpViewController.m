...
NSString* KAboutUrl = @"http://m.qjt1000.com/AboutQJT.do";

NSString* KLoadingTextAbout = @"载入中...";
...
- (IBAction) onRefreshBtnClick:(id)sender
{
    ...
    [mTitleLabel setText: KLoadingTextAbout];
...
didFailLoadWithError: (NSError*)error
{
    ...
    if(mTitleLabel.text != nil &&
       [mTitleLabel.text isEqualToString: KLoadingTextAbout])
    {
        mTitleLabel.text = @"";
    }
